        ...
        <legend style="padding: 0em 0.5em 0em 0.5em; font-weight: bold;"><?php echo __('Edit HCM Fundamentals Course'); ?></legend>
            <table class="fieldset" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td class="field"><input type="text" id="datepicker1" name="hcm[start_date]" class="date" value="<?php echo $hcm->getStartDate(); ?>" />
                ...
                <tr>
                    ...
                    <td class="field"><input type="text" id="datepicker2" name="hcm[end_date]" class="date" value="<?php echo $hcm->getEndDate(); ?>" />
                    <img class="date-icon" src="<?php echo PLUGINS_URI; ?>/training/images/calendar.gif" alt="Calendar Date"/></td>
                </tr>
                <tr>
