...
<h1><?php echo __('All HCM Fundamentals Courses'); ?></h1>
    <table class="index" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr class="<?php echo odd_even(); ?>">
            ...
            <td align="right"><a href="<?php echo get_url('plugin/training/updatehcm/'.$courses->id); ?>"><img src="<?php echo PLUGINS_URI; ?>/training/images/edit.gif" alt="Edit" /></a></td>
            <td><a href="<?php echo get_url('plugin/training/deletehcm/'.$courses->id); ?>"><img src="<?php echo PLUGINS_URI; ?>/training/images/trash.gif" alt="Delete" /></a></td>
        </tr>
        <?php } ?>
    </table>
